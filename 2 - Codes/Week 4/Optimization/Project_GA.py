...
filename1 = 'Runs_GA/Origin.$2k' # INPUT
filename2 = 'Runs_GA/Particle.$2k' # OUTPUT
filename3 = 'Runs_GA/Best.$2k' # OUTPUT
...
def RunSAP2000(filename2):
    ...
    APIPath = script_directory+'\Runs_GA'
...
print("Final Weight is:","{:.2f}".format(round(model.best_function, 3)),"kN")
print("Best cross-sections are:",model.best_variable*m**2,"mm**2")

pos_Names = []
df = pd.read_csv('Runs_GA/TUBO.csv')
for ij in range(n_frames):
    Area = model.best_variable[ij]
